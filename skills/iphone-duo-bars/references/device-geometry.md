...
| Label | Meaning |
| --- | --- |
| **Apple spec** | [iPhone Duo tech specs](https://www.apple.com/iphone-duo/specs/), checked 2026-09-13 |
...
| Size classes | regular × regular | like other iPhones (compact width) | Tech Talk 111461 2:46; HIG |
...
Apple has not published point sizes. Two third-party claims disagree:

- **626 × 890 pt** inner display — the panel divided by 3
  ([MacRumors roundup](https://www.macrumors.com/roundup/iphone-duo/), Wikipedia).
  *Unverified.*
- **669 × 951 pt** inner display rendered at @3x and downsampled to the panel
  (≈ 6.4 %), outer display **466 × 678 pt** at @3x 1:1, outer display compact ×
  compact in landscape, inner display regular × regular in every pose
  (Blake Crosley, [*iPhone Duo for developers*](https://blakecrosley.com/blog/iphone%2Dduo-for-developers)). *Unverified.*

Until an iPhone Duo simulator (Xcode 27.1) reports scene bounds and
`displayScale`, state both and pick neither. Code must not care either way.
